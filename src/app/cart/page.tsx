...
const CartPage = () => {
  ...
  const [isMoutnted, setIsMoutnted] = useState(false);
  const router = useRouter();

  const { mutate: createCheckoutSession, isLoading } =
    trpc.payment.createSesson.useMutation({
      onSuccess: ({ url }) => {
                ...
                items.map(({ product }) => {
                  ...
                  return (
                    <li key={product.id} className="flex py-6 sm:py-10">
                      ...
                      <div className="ml-4 flex w-full flex-col justify-between sm:ml-6">
                        ...
                        <p className="mt-4 flex space-x-2 text-sm text-gray-700">
                          ...
                          <span>Eligible for instamt delivery</span>
                        </p>
                      </div>
                    </li>
                  );
