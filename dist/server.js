...
var start = function () { return __awaiter(void 0, void 0, void 0, function () {
    var webhookMiddlware, payload;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                webhookMiddlware = body_parser_1.default.json({
                    verify: function (req, _, buffer) {
                        req.rawBody = buffer;
                    },
                });
                app.post("/api/webhooks/stripe", webhookMiddlware, webhooks_1.stripeWebhookHandler);
            ...
            case 1:
                ...
                next_utils_1.nextApp.prepare().then(function () {
                    ...
                    app.listen(PORT, function () { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            payload.logger.info("Mext app url: ".concat(process.env.NEXT_PUBLIC_SERVER_URL));
                            return [2 /*return*/];
                        });
                    }); });
                });
