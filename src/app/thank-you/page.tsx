...
const ThankYouPage = async ({ searchParams }: PageProps) => {
  ...
  return (
    <main className="relative lg:min-h-full">
      <div className="hidden h-80 overflow-hidden lg:absolute lg:block lg:h-full lg:w-1/2 xl:pr-12">
        <Image
          fill
        ...
        <div className="lg:col-start-2">
          ...
          {order._isPaid ? (
            <p className="mt-2 text-base text-muted-foreground">
              ...
              dowonload below. We&apos;ve sent your reciept and order details to{" "}
            ...
            <p className="mt-2 text-base text-muted-foreground">
              We apprecieate your order and we&apos;re currently processing it.
